...
export function ZoneCard({
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className="relative flex-shrink-0 w-full h-[9rem]">
        <img
          src={zone.image}
          alt={zone.name}
      ...
      <div className="flex-1 flex flex-col" style={{ padding: '0.75rem', gap: '0.5rem' }}>
        <div>
          <h3
            style={{
              fontSize: '1rem',
          ...
          {zone.features.slice(0, 2).map((feature, i) => (
            <div key={i} className="flex items-start" style={{ gap: '0.25rem' }}>
              <div
                ...
                style={{ width: '0.75rem', height: '0.75rem', marginTop: '0.125rem' }}
              >
                <div
                  style={{
                    width: '0.25rem',
